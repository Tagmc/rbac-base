  ...
  return (
    <Box
      sx={{
        ...
        background: 'url("src/assets/bg-huy.jpg")',
        ...
        <Zoom in={true} style={{ transitionDelay: "200ms" }}>
          ...
          >
            <Box sx={{ width: "70px", bgcolor: "white", margin: "0 auto" }}>
              <img src={EmHuyTapCodeIcon} alt="EmHuyTapCode" width="100%" />
            </Box>
            <Box
              sx={{
                display: "flex",
            ...
            >
              <Box>
                <Typography>Hint: emhuytapcode@gmail.com</Typography>
                <Typography>Pass: EmHuyTapCode@123</Typography>
              </Box>
            </Box>
